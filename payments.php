...
input, textarea {
    appearance: none;
    -webkit-appearance: none; /* Pour les navigateurs WebKit comme Chrome, Safari */
...
<rect fill="white" height="38.1" width="80"></rect>
  ...
  <div class="credit-card-info--form">
    ...
    <button class="purchase--btn"><a href="checkout.php">Checkout</a></button>
</form>
</div>
</body>
</html>
